...
public:
	...
	*/
	std::string get_metadata_str(bool const fill_autogenerated_data = true) const
	{
		...
		if (fill_autogenerated_data)
		{
			...
			set_metadata_value(metadata_, "num_ticks",            static_cast < unsigned int > (get_num_ticks()));
			set_metadata_value(metadata_, "num_ticks_per_second", static_cast < unsigned int > (get_num_ticks_per_second()));
