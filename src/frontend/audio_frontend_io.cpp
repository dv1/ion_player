...
void audio_frontend_io::set_current_position(unsigned int const new_position)
{
...
void audio_frontend_io::issue_get_position_command()
{
	send_line_to_backend_callback("get_current_position");
}


unsigned int audio_frontend_io::get_current_position() const
{
